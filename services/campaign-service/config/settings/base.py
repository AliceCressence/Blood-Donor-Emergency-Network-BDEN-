...
INSTALLED_APPS = ["django_prometheus", "unfold", "unfold.contrib.filters", "unfold.contrib.forms", "django.contrib.admin", "django.contrib.sessions", "django.contrib.messages", "django.contrib.staticfiles", "django.contrib.contenttypes", "django.contrib.auth", "rest_framework", "corsheaders"]
...
UNFOLD = {"SITE_TITLE": "BDEN Campaign Service Admin", "SITE_HEADER": "Blood Donor Emergency Network", "SITE_SYMBOL": "favorite", "SITE_FAVICONS": [{"rel": "icon", "href": "/static/favicon.svg", "type": "image/svg+xml"}]}
