...
UNFOLD = {"SITE_TITLE": "BDEN Request Service Admin", "SITE_HEADER": "Blood Donor Emergency Network", "SITE_SYMBOL": "favorite", "SITE_FAVICONS": [{"rel": "icon", "href": "/static/favicon.svg", "type": "image/svg+xml"}]}
